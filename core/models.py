...
class CreatedModifiedModel(models.Model):
    """Abstract model with auto filled created and modified date. Ordering by creation date ascending."""
    ...
    """Automatically set the field to now every time the object is saved by calling save() method. Notice, that it is not getting affect by calling update() method."""
